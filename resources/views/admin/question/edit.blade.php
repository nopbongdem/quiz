...
@section('content')
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        	{!! Form::model($data, ['route' => array('admin.question.update', $data->id), 'prefix'=>'admin', 'role'=>'form', 'id' => 'bookForm', 'onload' => 'LoadForm()' ]) !!}
                ...
                <div id="entry1" class="clonedInput">
                    ...
                    <div class="form-group">
	                    ...
	                    <div class="row">
							<div class="col-xs-2">
		                      	{!! Form::text('key', 1, array('class' => 'form-control', 'name'=>'key[]', 'placeholder' => 'Number')) !!}
		                    </div>
                            <div class="col-xs-6">
                    ...
                    <div class="form-group hide" id="cloneTemplate">
	                    ...
	                    <div class="row">
							<div class="col-xs-2">
		                      	{!! Form::text('key', null, array('class' => 'form-control', 'name'=> 'keys', 'placeholder' => 'Chapter name')) !!}
		                    </div>
		                    <div class="col-xs-6">
...
<script type="text/javascript">
    ...
    window.onload = function(){
        ...
        $clone
            .find('[name="keys"]').attr('name', 'key[' + bookIndex + ']').val(bookIndex + 1).end()
            .find('[name="values"]').attr('name', 'value[' + bookIndex + ']').end();

        $('#bookForm')
            .formValidation('addField', 'key[' + bookIndex + ']', priceValidators)
            .formValidation('addField', 'value[' + bookIndex + ']', titleValidators);
    ...
    .on('click', '.removeButton', function() {
        ...
        $('#bookForm')
            .formValidation('removeField', $row.find('[name="key[' + index + ']"]'))
