		...
		<div class="col-md-6 col-lg-6">
			<div class="box box-primary">
                <div class="box-header">
                	<h3 class="box-title">{!! trans('labels.language') !!}</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                {!! Form::model($data, ['method'=>'PUT', 'route' => array('admin.language.update', $data->id), 'prefix'=>'admin', 'role'=>'form' ]) !!}
	                <div class="box-body">
	                    ...
	                    <div class="form-group">
		                	...
		                	<div class="input-group">
								<a href="http://fakeanh.com/filemanager/dialog.php?type=1&field_id=flag&crossdomain=1&akey={!! Config::get('core.filemanager_key') !!}" class="input-group-addon iframe-btn">{!! FA::icon('image') !!}</a>
								{!! Form::text('flag', null, array('class' => 'form-control', 'id' => 'flag')) !!}
