    ...
    $.summernote.addPlugin({
        ...
        buttons: { // buttons
            ...
            helloDropdown: function() {
                var list = '<li><a data-event="helloDropdown" href="#" data-value="Recycle Bin">summernote</a></li>';
         ...
         */
        events: { // events
            filemanager: function(event, editor, layoutInfo) {
                var $dialog = layoutInfo.dialog(),
                    $editable = layoutInfo.editable(),
                    text = getTextOnRange($editable);

                editor.saveRange($editable);
                editor.showHelpDialog($editable, $dialog);
