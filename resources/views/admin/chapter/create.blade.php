...
@section('content')
	<div class="row">
	{!! Form::open(['url' => 'admin/chapter', 'role'=>'form' ]) !!}
			...
			<div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
	                    ...
	                    <div class="col-xs-4">
	                      	{!! Form::text('start', null, array('class' => 'form-control', 'placeholder' => 'Start')) !!}
							<small class="text-danger">{{ $errors->first('start') }}</small>
	                    </div>
	                    <div class="col-xs-4">
	                      	{!! Form::text('end', null, array('class' => 'form-control', 'placeholder' => 'End')) !!}
